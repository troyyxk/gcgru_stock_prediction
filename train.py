...
from input_data import preprocess_data, load_dow_price_data
...
def main(data_addr, adj_addr, s_index, lr, n_neurons, seq_len, n_epochs, batch_size, n_off):
    ...
    cell = gcgru(n_neurons, adj, n_gcn_nodes, s_index)
    optimizer = tf.keras.optimizers.Adam(learning_rate=lr)

    model = Sequential()
    model.add(RNN(cell, input_shape=(seq_len, n_gcn_nodes), return_sequences=True))
